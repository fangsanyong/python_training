...
//一、图像处理
    ...
    string image_path = "/home/zhuoyu/fsy/YoloV5-TensorRT-inference-main/sample_photo/images/bus.jpg";
    //string image_path = "/home/zhuoyu/fsy/YoloV5-TensorRT-inference-main/sample_photo/images/zidane.jpg";  //填写自己图片路径(需要绝对路径)
...
//二、模型反序列化
    MyLogger logger;
    //读取trt信息
    const std::string engine_file_path = "/home/zhuoyu/fsy/YoloV5-TensorRT-inference-main/sample_photo/best.trt";  //填写自己trt文件路径(需要绝对路径)
...
//六、画框
    ...
    cv::imwrite("/home/zhuoyu/fsy/YoloV5-TensorRT-inference-main/sample_photo/fsy.jpg", input_image);
    return 0;
}
