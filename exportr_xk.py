...
def set_parser():
    ...
    parser.add_argument( "--weights", type=str, default="pdcarani-20230518.pt", help="weights path")  # from yolov5/models/
    parser.add_argument("--img-size", nargs="+", type=int, default=[224, 320], help="image size h w")  # height, width
    parser.add_argument( "--config-file",type=str, default="models/yolov5s.yaml", help="model config path", )
