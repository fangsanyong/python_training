...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/20230731hw-imageweight-aug/weights/best.pt', help='initial weights path')
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/hw_wm.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='hw', help='save to project/name')
