...
Usage:
    ...
    $ python path/to/train.py --data coco128.yaml --weights '' --cfg yolov5s.yaml --img 640  # from scratch
     CUDA_VISIBLE_DEVICES=0,1 nohup python -m torch.distributed.launch --nproc_per_node=2 train_person_wm_nwd.py --batch-size 64 --device 0,1 >1.txt &
...
from utils.datasets_pcub import create_dataloader
...
def parse_opt(known=False):
    ...
    # parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/person_ota/weights', help='initial weights path')
    parser.add_argument('--weights', type=str, default=None, help='initial weights path')
    #parser.add_argument('--cfg', type=str, default='models/yolov5s.yaml', help='model.yaml path')
    #parser.add_argument('--data', type=str, default=ROOT / 'data/coco128.yaml', help='dataset.yaml path')
    parser.add_argument('--cfg', type=str, default='models/yolov5m-pcub-wm.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/pcub.yaml', help='dataset.yaml path')
    
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/hyp.scratch-low-nwd.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--image-weights', action='store_true',default=False, help='use weighted image selection for training')
    ...
    parser.add_argument('--name', default='pcub_nwd', help='save to project/name')
