...
from utils.datasets_bird import create_dataloader
...
from utils.loss import ComputeLoss,ComputeLossOTA1
...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    compute_loss_ota = ComputeLossOTA1(model)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/bird_nwd_all_lite/weights/best.pt', help='initial weights path')
    # parser.add_argument('--weights', type=str, default=None, help='initial weights path')
    #parser.add_argument('--cfg', type=str, default='models/yolov5s.yaml', help='model.yaml path')
    #parser.add_argument('--data', type=str, default=ROOT / 'data/coco128.yaml', help='dataset.yaml path')
    parser.add_argument('--cfg', type=str, default='models/yolov5s_lite.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/bird_all.yaml', help='dataset.yaml path')
    
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/hyp.scratch-low-bird.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--name', default='bird_nwd_all_lite', help='save to project/name')
