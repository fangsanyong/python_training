...
def export_onnx(model, im, file, opset, train, dynamic, simplify, prefix=colorstr('ONNX:')):
    ...
    try:
        ...
        torch.onnx.export(model.cuda(), im.cuda(), f, verbose=False, opset_version=opset,
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./runs/train/mix12/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[512, 640], help='image (h, w)')
    # parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[224, 320], help='image (h, w)')
    ...
    parser.add_argument('--dynamic', action='store_true',default=False, help='ONNX/TF: dynamic axes')
    ...
    parser.add_argument('--include', nargs='+', default=['engine'],help='torchscript, onnx, openvino, engine, coreml, saved_model, pb, tflite, edgetpu, tfjs')
...
##python export.py --weights /home/coco/yolov5-6.1/runs/train/exp16/weights/best.pt --img 640 --batch 1 --include onnx  --dynamic