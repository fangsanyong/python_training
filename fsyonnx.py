...
# model=torch.load("/home/coco/yolov5-6.1/runs/train/exp16/weights/best.pt",map_location=torch.device('cpu'))
# model.eval()
# input_names=["input"]
# output_names=["output"]

# torch.onnx.export(model,x,"/home/coco/yolov5-6.1/runs/train/exp16/weights/best_fsy.onnx",verbose=True,input_names=input_names,output_names=output_names,opset_version=11)
...
if __name__=='__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s-hw.yaml', help='yaml file path')
    parser.add_argument('--weights', type=str, default='/home/coco/yolov5-6.1/runs/train/exp16/weights/best.pt', help='model.pt path')
