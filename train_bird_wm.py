...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/bird.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='bird_ota', help='save to project/name')
