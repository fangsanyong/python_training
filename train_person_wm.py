...
Usage:
    ...
    $ python path/to/train.py --data coco128.yaml --weights '' --cfg yolov5s.yaml --img 640  # from scratch
     CUDA_VISIBLE_DEVICES=0,1 nohup python -m torch.distributed.launch --nproc_per_node=2 train_person_wm.py --batch-size 64 --device 0,1 >1.txt &
...
def parse_opt(known=False):
    ...
    parser.add_argument('--name', default='person_ota', help='save to project/name')
