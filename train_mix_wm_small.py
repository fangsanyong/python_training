...
def parse_opt(known=False):
    ...
    # parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/mix7/weights/best.pt', help='initial weights path')
    ...
    parser.add_argument('--name', default='small', help='save to project/name')
