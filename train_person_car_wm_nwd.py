...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/person_car_nwd/weights/best.pt', help='initial weights path')
    # parser.add_argument('--weights', type=str, default=None, help='initial weights path')
    #parser.add_argument('--cfg', type=str, default='models/yolov5s.yaml', help='model.yaml path')
    #parser.add_argument('--data', type=str, default=ROOT / 'data/coco128.yaml', help='dataset.yaml path')
    parser.add_argument('--cfg', type=str, default='models/yolov5m-person-car-wm.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/person_car.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='person_car_nwd', help='save to project/name')
