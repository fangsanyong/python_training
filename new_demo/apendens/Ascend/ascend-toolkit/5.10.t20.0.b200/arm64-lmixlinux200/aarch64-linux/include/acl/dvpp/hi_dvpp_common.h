...
typedef enum {
    ...
    HI_PIXEL_FORMAT_RGBA_4444,
    HI_PIXEL_FORMAT_BGRA_4444,
    ...
    HI_PIXEL_FORMAT_RGBA_1555,
    HI_PIXEL_FORMAT_BGRA_1555,
    HI_PIXEL_FORMAT_ARGB_8565,
    HI_PIXEL_FORMAT_ABGR_8565,
    HI_PIXEL_FORMAT_RGBA_8565,
    HI_PIXEL_FORMAT_BGRA_8565,
